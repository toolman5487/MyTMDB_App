...
// MARK: - MemberSettingProfileSummaryCollectionViewCell

@MainActor
final class MemberSettingProfileSummaryCollectionViewCell: UICollectionViewListCell {

    static let reuseIdentifier = String(describing: MemberSettingProfileSummaryCollectionViewCell.self)
    ...
    func configure(with item: MemberSettingProfileSummaryItem) {
    ...
    private func makeContentConfiguration(
        for item: MemberSettingProfileSummaryItem,
        avatarImage: UIImage
