//
//  TVReviewListViewController.swift
//  MyTMDB_App
//
...
@MainActor
final class TVReviewListViewController: ScrollTrackingBaseViewController {
    ...
    convenience init(seriesID: Int) {
        self.init(
            seriesID: seriesID,
            viewModel: TVDetailReviewViewModel()
        )
    }
    ...
    required init?(coder: NSCoder) {
        self.seriesID = 0
        self.viewModel = TVDetailReviewViewModel()
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(
            TVDetailReviewCollectionViewCell.self,
            forCellWithReuseIdentifier: TVDetailReviewCollectionViewCell.reuseIdentifier
        )
        collectionView.register(
            TVDetailReviewFilterHeaderView.self,
            forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
            withReuseIdentifier: TVDetailReviewFilterHeaderView.reuseIdentifier
        )
        collectionView.register(
            TVDetailReviewLoadingFooterView.self,
            forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter,
            withReuseIdentifier: TVDetailReviewLoadingFooterView.reuseIdentifier
        )
    }
    ...
    private func loadReviews() {
        ...
        loadTask = Task(priority: .userInitiated) { [weak self] in
            ...
            await viewModel.loadReviews(seriesID: seriesID)
    ...
    private func render(state: TVDetailReviewViewState) {
        switch state {
        case .idle:
            filters = []
            reviews = []
    ...
    private func makeFilterItems() -> [TVDetailReviewFilterItem] {
        TVDetailReviewFilter.allCases.map {
    ...
    private func presentReviewDetail(for review: TVReviewDetailItem) {
...
extension TVReviewListViewController: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: TVDetailReviewCollectionViewCell.reuseIdentifier,
            for: indexPath
        )
        (cell as? TVDetailReviewCollectionViewCell)?.configure(with: reviews[indexPath.item])
        return cell
    }
    ...
    func collectionView(
        ...
        if kind == UICollectionView.elementKindSectionFooter {
            ...
            if let footerView = reusableView as? TVDetailReviewLoadingFooterView {
        ...
        if let headerView = reusableView as? TVDetailReviewFilterHeaderView {
...
extension TVReviewListViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(
        ...
        let height = TVDetailReviewCollectionViewCell.fittingHeight(
