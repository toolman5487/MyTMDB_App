...
| 狀態 | Phase 1 完成；Phase 2 已完成分層實作 6 / 11 個 feature（EpisodeDetail、PersonDetail 待 build 與手動走查） |
| 日期 | 2026-09-13 |
...
| `PersonDetail` | **分層實作完成**；DTO 外洩與舊 Service 已移除，靜態檢查通過，待 build 與手動走查 |
| `MainMediaList` | 未開始；列為下一個遷移項目 |
| `Search` | 未開始 |
| `HomeSectionList` | 未開始 |
| `MainHome` | 未開始 |
