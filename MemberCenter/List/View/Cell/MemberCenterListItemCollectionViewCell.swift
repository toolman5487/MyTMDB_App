//
//  MemberCenterListItemCollectionViewCell.swift
//  MyTMDB_App
//
...
// MARK: - MemberCenterListItemCollectionViewCell

@MainActor
final class MemberCenterListItemCollectionViewCell: BaseCollectionViewCell {

    static let reuseIdentifier = String(describing: MemberCenterListItemCollectionViewCell.self)
