//
//  MemberCenterGuestLoginCollectionViewCell.swift
//  MyTMDB_App
//
...
// MARK: - MemberCenterGuestLoginCollectionViewCell

@MainActor
final class MemberCenterGuestLoginCollectionViewCell: BaseCollectionViewCell {

    static let reuseIdentifier = String(describing: MemberCenterGuestLoginCollectionViewCell.self)
    ...
    func configure(with prompt: MemberCenterGuestLoginPrompt) {
